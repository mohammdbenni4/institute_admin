...
class ScoringSettingsModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    revision_4_points: Mapped[int] = mapped_column(SmallInteger, nullable=False, default=7)
    revision_3_points: Mapped[int] = mapped_column(SmallInteger, nullable=False, default=5)
    revision_2_points: Mapped[int] = mapped_column(SmallInteger, nullable=False, default=3)
    revision_1_points: Mapped[int] = mapped_column(SmallInteger, nullable=False, default=0)
